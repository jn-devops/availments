...
class AvailmentData extends Data
{
     ...
     * @param float $holding_fee
     * @param float $total_contract_price
     * @param float $percent_miscellaneous_fees
     * @param float $miscellaneous_fees
     * @param float $net_total_contract_price
     * @param float $percent_down_payment
     * @param float $total_contract_price_down_payment_amount
     * @param float $total_contract_price_balance_down_payment_amount
     * @param int $total_contract_price_balance_down_payment_term
     * @param float $total_contract_price_balance_down_payment_amortization_amount
     * @param float $miscellaneous_fees_down_payment_amount
     * @param float $percent_balance_payment
     * @param float $total_contract_price_balance_payment_amount
     * @param float $miscellaneous_fees_balance_payment_amount
     * @param float $loan_amount
     * @param int $loan_term
     * @param float $loan_interest
     * @param float $loan_amortization_amount
     * @param float $low_cash_out_amount
     * @param float $balance_cash_out_amount
